...
namespace EmprendimientoApi.Migrations
{
    ...
    [Migration("20260711012220_AgregarMotivoAjusteInventario")]
    partial class AgregarMotivoAjusteInventario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmprendimientoApi.Models.AjusteStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DiferenciaDinero")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("EmprendimientoApi.Models.MovimientoStock", b =>
                {
                    ...
                    b.Property<int?>("MovimientoAnuladoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MovimientoAnuladoId");
            ...
            modelBuilder.Entity("EmprendimientoApi.Models.MovimientoStock", b =>
                {
                    b.HasOne("EmprendimientoApi.Models.MovimientoStock", "MovimientoAnulado")
                        .WithMany()
                        .HasForeignKey("MovimientoAnuladoId");
                    ...
                    b.Navigation("MovimientoAnulado");
